  ...
  return (
    <Styles>
      <Container>
        ...
        <a href="https://wa.me/+447472371528?text=Hi,%20I%20came%20from%20the%20website.%20I'd%20like%20to%20get%20a%20quote!" rel="noreferrer" target="_blank" className="whatsapp-button">
          <h3>Click here!</h3> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
